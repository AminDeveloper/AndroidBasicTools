package ir.mo.amin.hosseini.calendarview.Adapters
...
import ir.mo.amin.hosseini.calendarview.Model.CalendarModels.CalendarDayItem.Companion.initializeCount
...
class MonthCustomAdapter(var calendarItems: List<CalendarDayItem>, val context: Context) : RecyclerView.Adapter<MonthCustomAdapter.ViewHolder>() {
...
//        }
        ...
        SmartLogger.logDebug("took nothing" + initializeCount++ + "for" + holder.thisDay!!.persianMonth)
